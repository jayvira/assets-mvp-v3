...
const Panel: React.FC<PanelProps> = ({ title, isOpen, children, onClose, panelWidth = '248px', hideHeader = false, leftOffset = '35px' }) => {
  ...
  return (
    <div 
      ref={panelRef}
      className="fixed top-[35px] h-[calc(100vh-35px)] bg-[var(--bg-primary)] border-r border-[var(--border-default)] z-10 overflow-hidden flex flex-col"
      style={{
        left: leftOffset,
        width: panelWidth,
